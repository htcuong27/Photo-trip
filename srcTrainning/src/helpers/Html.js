...
export default class Html extends Component {
  ...
  render() {
    ...
    const domainImg = assets.domain === 'umbala.vn' ? '//vipn.net/um' : '//img.' + assets.domain;
    return (
      <html lang="en-US">
        <head>
          ...
          <link rel="shortcut icon" href={domainImg + '/favicon.ico'} />
          <meta name="viewport" content="width=device-width, initial-scale=1" />
          <link rel="manifest" href={config.img + '/libs/manifest.json'} />
          <meta name="theme-color" content="#3677dd" />
          {/*<link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,600,700&amp;subset=vietnamese" rel="stylesheet" />*/}
          ...
          <link async href={config.img + '/libs/normalize.min.css'} rel="stylesheet" />
          ...
          <link async rel="stylesheet" href={config.img + '/libs/swiper.min.css'} />
        </head>
        <body>
          <div id="content" dangerouslySetInnerHTML={{ __html: content }} />
          {assets.javascript && store && <script
