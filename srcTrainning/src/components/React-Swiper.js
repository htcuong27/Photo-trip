(function (root, factory) {
  ...
  var ReactIDangerousSwiper = React.createClass({
    ...
    componentDidUpdate: function () {
      if(typeof this.props.rebuildOnUpdate !== 'undefined') {
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.Children.map(this.props.children, function (e) {
            return React.cloneElement(e, { className: [slideClass, className, e.props.className].join(' ') });
          })
        ),
        React.createElement('div', { className: 'swiper-pagination' }),
        this._renderScrollBar(),
        this.props.nextButtonComponent || this._renderNextButton(),
        this.props.prevButtonComponent || this._renderPrevButton()
      );
    }
  });
